...
I am an automotive graduate with technical and operational experience in various background. As an Engineerh aving a constant profound interest in technology and a dedication to solving complex problems is a trait instill by Nature.
...
|-----------------------------------------------|----------------------------|
| SIEM                                          | CYBRARY|
| LOG ANALYSIS                                  | CYBRARY|
| SECURITY TICKETING                            | CYBRARY|
| DEFENSIVE SECURITY OPERATIONS                 | CYBRARY|
| DEFENSIVE SECURTIY AND CYBER RISK             | CYBRARY|
